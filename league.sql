...
INSERT INTO `team` (`id`, `name`, `region`, `big_team`, `caf_qualifier`, `league_type`, `venue_name`) VALUES
...
ZDgyYmU3MTcyZGY0OGFiNDVjNTIxNzk3YjY4NTc1M2JkNDc4ZTk3MGY2MGI0Y2ZiODA5M2I1ZDJjZmVmNTQ2Mg==
-- --------------------------------------------------------
...
(6, 'Majaliwa Stadium', 'Lindi', 'light', 'Premier'),
(7, 'Jamhuri  Stadium', 'Dodoma', 'light', 'Premier'),
(8, 'Lake Tanganyika ', 'Kigoma', 'no light', 'Premier'),
