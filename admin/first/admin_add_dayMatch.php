<?php
  ...
  if (isset($_POST['reg_day_match'])) {
    ...
    if ($stmt) {
        $stmt->bind_param('sis', $name, $number_of_matches,$league_type); // 'si' indicates a string and an integer
        $stmt->execute();
    ...
    <span class="mask bg-gradient-default opacity-5"></span>
                ...
                <div class="row">
                 ...
                 <?php
                        ...
                        $query = "SELECT name,league_type,season FROM $tableName WHERE league_type='First'   "; // Add your WHERE conditions if needed
