<?php
  ...
  $admin_id = $_SESSION['admin_id'];
		...
		if(isset($_POST['update_premier_league']))
		{
            $id = $_GET['id'];
            $name = $_POST['name'];
            ...
            $query="UPDATE  premier_league SET name=?, start_date=?, end_date=?, season=? WHERE id =?";
    ...
    <div class="header  pb-8 pt-5 pt-md-8" style="min-height: 300px; background-image: url(../../img/header-bg.jpg); background-size: cover; background-position: center top;">
        ...
        <div class="container-fluid mt--7">
            <?php
                ...
                $id = $_GET['id'];
                $ret="SELECT  * FROM premier_league WHERE id=?";
            ...
            <div class="row">
                <div class="card col-md-12">
                    ...
                    <div class="row">
                            ...
                            <button type="submit" name="update_premier_league" class="btn btn-primary">Add League</button>
                        </form>
                        <!-- ./ Form -->
                    </div>    
                </div>
