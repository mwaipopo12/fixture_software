<?php
  ...
  $admin_id = $_SESSION['admin_id'];
		...
		if(isset($_POST['update_team']))
		{
            ...
            $query="UPDATE  team SET   name=?,  region=?, big_team=?, caf_qualifier=?, venue_name=? WHERE id =?";
            $stmt = $mysql->prepare($query);
            $rc=$stmt->bind_param('sssssi', $name,   $region, $big_team, $caf_qualifier, $venue_name,$id);
            $stmt->execute();
    ...
    <div class="header  pb-8 pt-5 pt-md-8" style="min-height: 300px; background-image: url(../../img/header-bg.jpg); background-size: cover; background-position: center top;">
        ...
        <div class="container-fluid mt--7">
            <?php
                ...
                $id = $_GET['id'];
                $ret="SELECT  * FROM  team WHERE id=? league_type='first' ";
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group col-md-6">
                             ...
                             <select value ="<?php echo $row->big_team;?>" required name="bigteam" class="form-control" id="bigteam">
                            ...
                            <div class="row">
                            <div class="form-group col-md-6">
                            <label for="venue_name">Team Venue</label>
                            <select value="<?php echo $row->venue_name;?>" class="form-control" required name="venue_name">
                          ...
                          ?>
                            ...
                            <button type="submit" name="update_team" class="btn btn-primary">Add Team</button>
                        </form>
                        <!-- ./ Form -->
                    </div>    
                </div>
