<?php
  ...
  $admin_id = $_SESSION['admin_id'];
		...
		if(isset($_POST['update_day_match']))
		{
            ...
            $query="UPDATE  day_match SET   name=?,  number_of_matches=?, league_type=? WHERE id =?";
            $stmt = $mysql->prepare($query);
            $rc=$stmt->bind_param('sssi', $name,   $number_of_matches,$league_type, $id);
            $stmt->execute();
    ...
    <div class="header  pb-8 pt-5 pt-md-8" style="min-height: 300px; background-image: url(../../img/header-bg.jpg); background-size: cover; background-position: center top;">
        ...
        <div class="container-fluid mt--7">
            <?php
                ...
                $id = $_GET['id'];
                $ret="SELECT  * FROM  day_match WHERE id=?, league_type='first'";
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                  ...
                  <input type="number" value ="<?php echo $row->number_of_matches;?>" required name="number_of_matches" class="form-control" id="number_of_matches" aria-describedby="emailHelp">
              </div> 
          </div>
                            ...
                            <button type="submit" name="update_day_match" class="btn btn-primary">Add Day</button>
                        </form>
                        <!-- ./ Form -->
                    </div>    
                </div>
