<?php
  ...
  $admin_id = $_SESSION['admin_id'];
		...
		if(isset($_POST['update_exceptional_date']))
		{
            $id = $_GET['id'];
            $name = $_POST['name'];
            ...
            $query="UPDATE  exceptional_date SET name=?, start_date=?, end_date=?, break_type=? WHERE id =?";
            $stmt = $mysql->prepare($query);
            $rc=$stmt->bind_param('ssssi',$name,$start_date, $end_date, $break_type,$id);
            $stmt->execute();
    ...
    <div class="header  pb-8 pt-5 pt-md-8" style="min-height: 300px; background-image: url(../../img/header-bg.jpg); background-size: cover; background-position: center top;">
        ...
        <div class="container-fluid mt--7">
            <?php
                ...
                $id = $_GET['id'];
                $ret="SELECT  * FROM  exceptional_date WHERE id=?";
            ...
            <div class="row">
                <div class="card col-md-12">
                    ...
                    <div class="row">
                            ...
                            <button type="submit" name="update_exceptional_date" class="btn btn-primary">Update Event</button>
                        </form>
                        <!-- ./ Form -->
                    </div>    
                </div>
