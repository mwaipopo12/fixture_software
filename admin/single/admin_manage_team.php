    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">Registered Team </h2>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col">Caf Qualifier</th>
                                <th scope="col">league_type</th>
                            ...
                            <?php
                                    ...
                                    $ret="SELECT * FROM team WHERE league_type= 'Single_leg' "; 
                            ...
                            ?>
                                ...
                                <td>
                                    <?php echo $row->big_team;?>
                                </td>
                                <td>
                                    <?php echo $row->caf_qualifier;?>
                                </td>
                                <td>
                                ...
                                <td>
                                        ...
                                        <a href  ="admin_update_team.php?id=<?php echo $row->id;?>&name=<?php echo $row->name;?>" class="badge badge-primary">
