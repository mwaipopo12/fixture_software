<?php
  ...
  if(isset($_GET['delete_id']))
  {
        ...
        $adn="DELETE FROM day_match WHERE id = ?";
    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">Selected Days </h2>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <?php
                                    ...
                                    $ret="SELECT * FROM day_match WHERE league_type='Single_leg' "; 
                            ...
                            ?>
                                ...
                                <td>
                                    <?php echo $row->number_of_matches;?>
                                </td>
                                <td>
                                ...
                                <td>
                                        ...
                                        <a href  ="admin_update_dayMatch.php?id=<?php echo $row->id;?>& name=<?php echo $row->name;?>" class="badge badge-primary">
                                            <i class="fa fa-edit"></i> <i class="fa fa-user"></i> 
                                                Update
                                        </a>
                                        <a href  ="admin_manage_dayMatch.php?delete_id=<?php echo $row->id;?>" class="badge badge-danger">
